...
public class GBuffer implements FrameBufferObject {
    ...
    private void createTextures(){
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB32F, WindowConfig.getInstance().getWidth(), WindowConfig.getInstance().getHeight(), 0, GL_RGB, GL_FLOAT, NULL);
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, WindowConfig.getInstance().getWidth(), WindowConfig.getInstance().getHeight(), 0, GL_RGBA, GL_UNSIGNED_BYTE, NULL);
        glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST);
        glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
    ...
    private void createRenderBuffer(){
        ...
        glRenderbufferStorage(GL_RENDERBUFFER, GL_DEPTH_COMPONENT, WindowConfig.getInstance().getWidth(), WindowConfig.getInstance().getHeight());
