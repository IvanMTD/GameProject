package ru.phoenix.engine.core.shader;
...
import ru.phoenix.engine.math.variable.Vector4f;
...
public class Shader {
    ...
    public void createVertexShader(String shaderFileName) {
        addProgram(ShaderLoader("./shader/vs/" + shaderFileName), GL_VERTEX_SHADER);
    }

    public void createGeometryShader(String shaderFileName){
        addProgram(ShaderLoader("./shader/gs/" + shaderFileName), GL_GEOMETRY_SHADER);
    }

    public void createFragmentShader(String shaderFileName){
        addProgram(ShaderLoader("./shader/fs/" + shaderFileName),GL_FRAGMENT_SHADER);
    }
