...
public class Projection {
    ...
    public void setPerspective(float fov){
        float aspect = WindowConfig.getInstance().getWidth() * 1.0f / WindowConfig.getInstance().getHeight();
        projection.setPerspective(fov,aspect, WindowConfig.getInstance().getzNear(), WindowConfig.getInstance().getzFar());
    }
